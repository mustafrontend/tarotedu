      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className={`w-full pl-9 pr-4 py-2.5 rounded-2xl text-xs font-medium focus:outline-none transition-colors border shadow-sm ${
              isDark
                ? 'bg-slate-900/90 border-purple-500/30 text-white placeholder-slate-400 focus:border-purple-400'
