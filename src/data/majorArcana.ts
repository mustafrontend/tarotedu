...
export const majorArcana: TarotCard[] = [
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'New beginnings, taking risks, spontaneity, innocence',
      reversed: 'Recklessness, thoughtlessness, naivety, risk-taking'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Resourcefulness, power, inspired action, willpower, manifestation',
      reversed: 'Manipulation, poor planning, untapped talents, lack of concentration'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Intuition, sacred knowledge, divine feminine, subconscious wisdom',
      reversed: 'Secrets, hidden agendas, breaking the silence, spiritual confusion'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Nurturing, femininity, beauty, abundance, nature, fertility',
      reversed: 'Insecurity, neglect, lack of self-care, low self-esteem, emptiness'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Authority, leadership, power, control, father figure, stability',
      reversed: 'Tyranny, rigidity, domination, lack of control, excessive rigidity'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Tradition, spiritual wisdom, organized religion, conformity, morality, ethics',
      reversed: 'Dogmatism, breaking rules, unorthodoxy, personal beliefs'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Self-discipline, lack of control, opposition, directionlessness'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Self-doubt, raw emotion, weakness, insecurity'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Loneliness, isolation, paranoia, withdrawal'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Resistance to change, personal transformation, fear of change'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Imbalance, excess, extreme behavior, lack of patience'
    },
    keywords: {
  ...
  },
  {
    ...
    meaning: {
      ...
      reversed: 'Personal transformation, averting disaster, delaying inevitable'
    },
    keywords: {
  ...
  },
  {
    ...
    arcana: 'major',
    meaning: {
      upright: 'Hope, faith, purpose, renewal, inspiration',
      reversed: 'Lack of faith, despair, self-doubt, discouragement'
    },
    keywords: {
